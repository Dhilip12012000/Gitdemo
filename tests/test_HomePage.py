...
class Testtwo(Baseclass):
    ...
    def test_submission(self, getData):
        ...
        homepage.getname().send_keys(getData["FirstName"])  #driver.find_element(By.NAME, 'name').send_keys('Amir')
        ...
        selfselectoption(homepage.getgender(), getData["Gender"])  #Select(self.driver.find_element(By.ID, 'exampleFormControlSelect1')).select_by_visible_text("Male")
    ...
    @pytest.fixture(params=[("FirstName: Rahul", "SecondName : Shetty", "Gender : Male"), ("Amir", "Khan", "Male")])
